	...
	class WPStatistics_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			if( $widget_options['useronline_widget'] ) {
				echo '<li>';
					echo '<label>' . __( 'Số người online', 'wp_statistics' ) . ': </label>';
			...
			if( $widget_options['tvisit_widget'] ) {
				echo '<li>';
					echo '<label>' . __( 'Hôm nay', 'wp_statistics' ) . ': </label>';
			...
			if( $widget_options['yvisit_widget'] ) {
				echo '<li>';
					echo '<label>' . __( 'Hôm qua', 'wp_statistics' ) . ': </label>';
			...
			if( $widget_options['mvisit_widget'] ) {
				echo '<li>';
					echo '<label>' . __( 'Trong tháng', 'wp_statistics' ) . ': </label>';
			...
			if( $widget_options['ttvisit_widget'] ) {
				echo '<li>';
					echo '<label>' . __( 'Tổng', 'wp_statistics' ) . ': </label>';
