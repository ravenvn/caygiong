...
function clean_commerce_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/third-party/font-awesome/css/font-awesome' . $min . '.css', '', '4.7' );
	...
	wp_enqueue_style( 'clean-commerce-style', get_stylesheet_uri(), array(), '1.0.4' );
