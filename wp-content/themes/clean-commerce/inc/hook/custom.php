		    	...
		    	<div id="cart-section">
		    		<ul>
		    			<li class="account-login">
			    			<a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>"><?php echo is_user_logged_in() ? __( 'Tài khoản của tôi', 'clean-commerce' ) : __( 'Đăng nhập', 'clean-commerce' ) ; ?></a>
			    		</li>
		    			<li class="cart-price"><a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><strong><?php _e( 'Giỏ hàng', 'clean-commerce' ) ?></strong>&nbsp;/&nbsp;<span class="amount"><?php echo WC()->cart->get_cart_total(); ?></span></a></li>
