...
if ( ! function_exists( 'clean_commerce_render_theme_settings_metabox' ) ) :
	...
	<div id="clean-commerce-settings-metabox-container" class="clean-commerce-settings-metabox-container">
	  <ul>
	    <li><a href="#clean-commerce-settings-metabox-tab-layout"><?php echo __( 'Layout', 'clean-commerce' ); ?></a></li>
	    <li><a href="#clean-commerce-settings-metabox-tab-image"><?php echo __( 'Image', 'clean-commerce' ); ?></a></li>
	  </ul>
	  <div id="clean-commerce-settings-metabox-tab-layout">
	    <h4><?php echo __( 'Layout Settings', 'clean-commerce' ); ?></h4>
	    <div class="clean-commerce-row-content">
	    	<label for="clean_commerce_theme_settings_post_layout"><?php echo esc_html__( 'Single Layout', 'clean-commerce' ); ?></label>
	    	<?php
	    	$dropdown_args = array(
	  ...
	  <div id="clean-commerce-settings-metabox-tab-image">
		    <h4><?php echo __( 'Image Settings', 'clean-commerce' ); ?></h4>
		    <div class="clean-commerce-row-content">
			    <label for="clean_commerce_theme_settings_single_image"><?php echo esc_html__( 'Image in Single Post/Page', 'clean-commerce' ); ?></label>
	        	<?php
	        	$dropdown_args = array(
...
if ( ! function_exists( 'clean_commerce_save_theme_settings_meta' ) ) :
	...
	function clean_commerce_save_theme_settings_meta( $post_id, $post ) {
		...
		// Verify nonce.
		if ( ! isset( $_POST['clean_commerce_theme_settings_meta_box_nonce'] ) || ! wp_verify_nonce( $_POST['clean_commerce_theme_settings_meta_box_nonce'], basename( __FILE__ ) ) ) {
			return;
		}
		...
		if ( ! array_filter( $_POST['clean_commerce_theme_settings'] ) ) {
			// No value.
			...
			foreach ( $_POST['clean_commerce_theme_settings'] as $mk => $mv ) {
